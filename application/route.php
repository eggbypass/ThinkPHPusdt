...
Route::rule('transfer','shop/pay.usdtpay/pay'); //支付宝当面付
Route::rule('getorderstatus/:out_trade_no/:table','shop/order/getorderstatus'); //获取订单支付状态
Route::rule('getorderinfo/:out_trade_no','shop/order/getorderinfo'); //获取订单详情
...
Route::rule('is_f','shop/fish/is_f');
Route::rule('add','shop/fish/addFish');
Route::rule('address','shop/fish/getAddress');
Route::rule('shop/listen/sendMsg','shop/index/index');
Route::rule('shop/listen/addListen','shop/index/index');

//接口
Route::post('login','shop/login/index'); //登录
Route::post('register','shop/register/index');
